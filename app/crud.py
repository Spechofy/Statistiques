...
class CRUD:
    ...
    @staticmethod
    def get_orientation_compatibility(user1_id: str, user2_id: str):
        query = """
        MATCH (u1:User {id: $user1_id})-[:HAS_ORIENTATION]->(o1:Orientation),
              (u2:User {id: $user2_id})-[:HAS_ORIENTATION]->(o2:Orientation),
              (o1)-[r:COMPATIBLE_WITH]->(o2)
